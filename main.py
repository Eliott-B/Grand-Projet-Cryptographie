...
def Code_Cesar(bt1,bt2,bt3):
    ...
    Entre2.pack()
    bouton = tk.Button(root, text="Crypter", command=lambda:Encrypt_Cesar(Entre1,Entre2,reponse))
    bouton.pack(pady=25)
...
def Code_Vigenere(bt1,bt2,bt3):
    ...
    Entre2.pack()
    bouton = tk.Button(root, text="Crypter", command=lambda:Encrypt_Vigenere(Entre1,Entre2,reponse))
    bouton.pack(pady=25)
    bouton1 = tk.Button(root, text="Décrypter", command=lambda:Decrypt_Vigenere(Entre1,Entre2,reponse))
...
def Code_Hill(bt1,bt2,bt3):
    ...
    bouton = tk.Button(root, text="Crypter", command=lambda:Encrypt_Hill(Entre1,Entre2,Entre3,Entre4,Entre5,reponse))
    bouton.pack(pady=25)
